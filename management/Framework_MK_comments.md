...
|What are the flow of events for each scenario associated with each use case?|| unclear. Part of 'data flows' or do we need a separate field to identify this explicitly?|
